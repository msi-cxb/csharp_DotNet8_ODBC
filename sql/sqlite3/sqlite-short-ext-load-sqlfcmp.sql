...
-- =============================================================
-- Test: sqlite_sqlfcmp (MEM segment)
-- Description: sqlfcmp extension - ULP arithmetic, sigdigits, format functions via load_extension
...
.print === sqlite_sqlfcmp MEM load_extension ===

-- Note: load_extension throws Function sequence error but extension loads
-- Note: expected to fail with: Function sequence error
SELECT load_extension('%APPDATA%\sqlite\64bit\sqlfcmp.dll') AS ext_loaded;
