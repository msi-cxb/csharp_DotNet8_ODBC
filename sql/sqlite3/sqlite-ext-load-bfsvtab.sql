...
-- =============================================================
-- Test: sqlite_extension_bfsvtab (SQL3 file segment)
-- Description: bfsvtab extension - BFS graph traversal via load_extension
...
.print === sqlite_extension_bfsvtab load_extension ===

SELECT load_extension('%APPDATA%\sqlite\64bit\bfsvtab.dll') AS ext_loaded;
