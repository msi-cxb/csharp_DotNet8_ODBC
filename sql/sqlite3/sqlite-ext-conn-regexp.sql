...
-- =============================================================
-- Test: sqlite_extension_functions_regex (SQL3-LoadExt-Regexp segment)
-- Description: regexp extension - REGEXP operator via connection string
-- Source: sqlite_extension_functions_regex in sqliteODBC_tests.vbs (line 2055)
-- Connection: sqlite3-regexp
-- =============================================================
...
.print === sqlite_extension_functions_regex SQL3-LoadExt-Regexp connection ===
