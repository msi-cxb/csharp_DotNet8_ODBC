...
-- Note: atn2 exists in native System.Data.SQLite (not in ODBC driver)
...
-- Note: cot exists in native System.Data.SQLite (not in ODBC driver)
SELECT cot(30*3.14159/180) AS x;

-- Note: coth exists in native System.Data.SQLite (not in ODBC driver)
...
-- RESULT:x,y,z
-- RESULT:3.3219280948873626,1,0.8304820237218407
...
-- Note: square exists in native System.Data.SQLite (not in ODBC driver)
