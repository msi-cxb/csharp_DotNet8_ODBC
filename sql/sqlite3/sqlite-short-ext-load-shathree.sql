...
-- =============================================================
-- Test: sqlite_extension_functions_sha (MEM segment)
-- Description: shathree extension - sha3, sha3_agg functions via load_extension
...
.print === sqlite_extension_functions_sha MEM load_extension ===

-- Note: load_extension throws Function sequence error but sha3 methods load
-- Note: expected to fail with: Function sequence error
SELECT load_extension('%APPDATA%\sqlite\64bit\shathree.dll') AS loaded;

.print === sha3 identity tests ===
