...
COPY FROM DATABASE biketrips TO memory;

DETACH biketrips;

-- RESULT:database,schema,name,column_names,column_types,temporary
-- RESULT:memory,main,hoods,[neighborhood, geom],[VARCHAR, GEOMETRY],false
-- RESULT:memory,main,rides,[bikeid, start_geom],[BIGINT, GEOMETRY],false
SHOW ALL TABLES;
