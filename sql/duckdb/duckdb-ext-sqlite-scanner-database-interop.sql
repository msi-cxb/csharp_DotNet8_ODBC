...
.delete [[__DATAFOLDER__]]\big_table.csv
.delete [[__DATAFOLDER__]]\big_table.parquet
.delete [[__DBFOLDER__]]\big_table.sqlite3
...
CREATE OR REPLACE TABLE big_table_sqlite.big_table AS SELECT * FROM big_table;
