...
-- RESULT:sqlite_scanner,true,true,C:\Users\charlie\.duckdb\extensions\v1.4.2\windows_amd64\sqlite_scanner.duckdb_extension,Adds support for reading and writing SQLite database files,[sqlite, sqlite3],0c93d61,REPOSITORY,.\extensions\duckdb
select * from duckdb_extensions() where extension_name = 'sqlite_scanner';

ATTACH '[[__DATAFOLDER__]]/sakila_master.db' AS sakila (TYPE sqlite);
...
-- RESULT:[[__DATAFOLDER__]]/data.parquet,duckdb_schema,null,null,REQUIRED,2,null,null,null,null,null,null
-- RESULT:[[__DATAFOLDER__]]/data.parquet,id,INT64,null,OPTIONAL,null,INT_64,null,null,null,null,BIGINT
-- RESULT:[[__DATAFOLDER__]]/data.parquet,name,BYTE_ARRAY,null,OPTIONAL,null,UTF8,null,null,null,null,VARCHAR
...
-- RESULT:[[__DATAFOLDER__]]/data.parquet,0,1,2,64,0,0,1,id,INT64,42,42,0,null,42,42,SNAPPY,PLAIN,null,null,4,33,31,{},null,null,true,true,1,null,null
-- RESULT:[[__DATAFOLDER__]]/data.parquet,0,1,2,64,1,0,1,name,BYTE_ARRAY,DuckDB,DuckDB,0,null,DuckDB,DuckDB,SNAPPY,PLAIN,null,null,37,35,33,{},null,null,true,true,1,null,null
...
-- RESULT:[[__DATAFOLDER__]]/data.parquet,DuckDB version v1.4.2 (build 68d7555f68),1,1,1,null,null,324,244
